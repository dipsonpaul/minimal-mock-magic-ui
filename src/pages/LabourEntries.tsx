          ...
          <div className="flex items-center justify-between h-12">
            <div className="flex items-center space-x-6">
              ...
              <nav className="hidden md:flex space-x-4">
                ...
                <Link to="/labour-entries" className="bg-blue-600 text-white px-2 py-0.5 rounded text-xs font-medium">LABOUR</Link>
            ...
            <div className="flex items-center space-x-3">
              <div className="bg-gray-600 text-white px-2 py-1 rounded text-xs">VENDOR LIST</div>
              <div className="bg-gray-600 text-white px-2 py-1 rounded text-xs">VENDOR PAYMENTS</div>
              <div className="bg-gray-600 text-white px-2 py-1 rounded text-xs">VOUCHERS</div>
